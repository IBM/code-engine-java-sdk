...
/**
 * Unit test class for the DeleteJobRunOptions model.
 */
public class DeleteJobRunOptionsTest {
  ...
  public void testDeleteJobRunOptionsError() throws Throwable {
    new DeleteJobRunOptions.Builder().build();
  }
