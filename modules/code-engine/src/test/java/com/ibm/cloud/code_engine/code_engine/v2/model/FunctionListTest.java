...
/**
 * Unit test class for the FunctionList model.
 */
public class FunctionListTest {
  ...
  @Test
  public void testFunctionList() throws Throwable {
    FunctionList functionListModel = new FunctionList();
    assertNull(functionListModel.getFirst());
    assertNull(functionListModel.getFunctions());
    assertNull(functionListModel.getLimit());
    assertNull(functionListModel.getNext());
  }
}