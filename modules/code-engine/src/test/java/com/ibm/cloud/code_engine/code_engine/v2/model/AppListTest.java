...
/**
 * Unit test class for the AppList model.
 */
public class AppListTest {
  ...
  @Test
  public void testAppList() throws Throwable {
    AppList appListModel = new AppList();
    assertNull(appListModel.getApps());
    assertNull(appListModel.getFirst());
    assertNull(appListModel.getLimit());
    assertNull(appListModel.getNext());
  }
}