...
/**
 * Unit test class for the DomainMappingList model.
 */
public class DomainMappingListTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDomainMappingList() throws Throwable {
    DomainMappingList domainMappingListModel = new DomainMappingList();
    assertNull(domainMappingListModel.getDomainMappings());
    assertNull(domainMappingListModel.getFirst());
    assertNull(domainMappingListModel.getLimit());
    assertNull(domainMappingListModel.getNext());
  }
}