...
public class CreateProjectOptionsTest {
  ...
  public void testCreateProjectOptions() throws Throwable {
    CreateProjectOptions createProjectOptionsModel = new CreateProjectOptions.Builder()
      ...
      .build();
    assertEquals(createProjectOptionsModel.name(), "my-project");
    assertEquals(createProjectOptionsModel.resourceGroupId(), "b91e849cedb04e7e92bd68c040c672dc");
    assertEquals(createProjectOptionsModel.tags(), java.util.Arrays.asList("testString"));
  }
