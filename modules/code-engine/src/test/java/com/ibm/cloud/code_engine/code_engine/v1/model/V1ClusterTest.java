...
/**
 * Unit test class for the V1Cluster model.
 */
public class V1ClusterTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testV1Cluster() throws Throwable {
    V1Cluster v1ClusterModel = new V1Cluster();
    assertNull(v1ClusterModel.getServer());
  }
}