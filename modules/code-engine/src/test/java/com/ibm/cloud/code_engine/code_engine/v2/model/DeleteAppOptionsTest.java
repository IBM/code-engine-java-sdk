...
/**
 * Unit test class for the DeleteAppOptions model.
 */
public class DeleteAppOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteAppOptions() throws Throwable {
  ...
  public void testDeleteAppOptionsError() throws Throwable {
    new DeleteAppOptions.Builder().build();
  }
