...
/**
 * Unit test class for the SecretList model.
 */
public class SecretListTest {
  ...
  @Test
  public void testSecretList() throws Throwable {
    SecretList secretListModel = new SecretList();
    assertNull(secretListModel.getFirst());
    assertNull(secretListModel.getLimit());
    assertNull(secretListModel.getNext());
    assertNull(secretListModel.getSecrets());
  }
}