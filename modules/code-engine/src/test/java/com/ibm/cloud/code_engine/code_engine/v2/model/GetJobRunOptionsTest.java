...
/**
 * Unit test class for the GetJobRunOptions model.
 */
public class GetJobRunOptionsTest {
  ...
  public void testGetJobRunOptionsError() throws Throwable {
    new GetJobRunOptions.Builder().build();
  }
