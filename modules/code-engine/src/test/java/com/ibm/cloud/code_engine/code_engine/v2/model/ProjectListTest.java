...
/**
 * Unit test class for the ProjectList model.
 */
public class ProjectListTest {
  ...
  public void testProjectList() throws Throwable {
    ProjectList projectListModel = new ProjectList();
    assertNull(projectListModel.getFirst());
    assertNull(projectListModel.getLimit());
    assertNull(projectListModel.getNext());
    assertNull(projectListModel.getProjects());
  }
}