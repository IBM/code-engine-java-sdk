...
/**
 * Unit test class for the V1AuthInfoRef model.
 */
public class V1AuthInfoRefTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testV1AuthInfoRef() throws Throwable {
    V1AuthInfoRef v1AuthInfoRefModel = new V1AuthInfoRef();
    assertNull(v1AuthInfoRefModel.getName());
    assertNull(v1AuthInfoRefModel.getUser());
  }
}