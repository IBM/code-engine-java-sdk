...
public class ListJobsOptionsTest {
  ...
  public void testListJobsOptions() throws Throwable {
    ListJobsOptions listJobsOptionsModel = new ListJobsOptions.Builder()
      ...
      .start("testString")
      .build();
    assertEquals(listJobsOptionsModel.projectId(), "15314cc3-85b4-4338-903f-c28cdee6d005");
    assertEquals(listJobsOptionsModel.limit(), Long.valueOf("100"));
    assertEquals(listJobsOptionsModel.start(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testListJobsOptionsError() throws Throwable {
    new ListJobsOptions.Builder().build();
  }
