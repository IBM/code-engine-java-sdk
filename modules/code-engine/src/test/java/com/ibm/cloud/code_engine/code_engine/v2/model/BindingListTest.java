...
/**
 * Unit test class for the BindingList model.
 */
public class BindingListTest {
  ...
  @Test
  public void testBindingList() throws Throwable {
    BindingList bindingListModel = new BindingList();
    assertNull(bindingListModel.getBindings());
    assertNull(bindingListModel.getFirst());
    assertNull(bindingListModel.getLimit());
    assertNull(bindingListModel.getNext());
  }
}