...
/**
 * Unit test class for the V1ContextRef model.
 */
public class V1ContextRefTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testV1ContextRef() throws Throwable {
    V1ContextRef v1ContextRefModel = new V1ContextRef();
    assertNull(v1ContextRefModel.getContext());
    assertNull(v1ContextRefModel.getName());
  }
}