...
/**
 * Unit test class for the AppRevisionList model.
 */
public class AppRevisionListTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAppRevisionList() throws Throwable {
    AppRevisionList appRevisionListModel = new AppRevisionList();
    assertNull(appRevisionListModel.getFirst());
    assertNull(appRevisionListModel.getLimit());
    assertNull(appRevisionListModel.getNext());
    assertNull(appRevisionListModel.getRevisions());
  }
}