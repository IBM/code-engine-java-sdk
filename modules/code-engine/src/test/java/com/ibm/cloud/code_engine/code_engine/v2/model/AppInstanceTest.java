...
/**
 * Unit test class for the AppInstance model.
 */
public class AppInstanceTest {
  ...
  @Test
  public void testAppInstance() throws Throwable {
    AppInstance appInstanceModel = new AppInstance();
    assertNull(appInstanceModel.getAppName());
    assertNull(appInstanceModel.getRevisionName());
