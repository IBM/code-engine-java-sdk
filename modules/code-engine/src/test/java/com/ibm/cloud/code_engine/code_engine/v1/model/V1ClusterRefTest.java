...
/**
 * Unit test class for the V1ClusterRef model.
 */
public class V1ClusterRefTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testV1ClusterRef() throws Throwable {
    V1ClusterRef v1ClusterRefModel = new V1ClusterRef();
    assertNull(v1ClusterRefModel.getCluster());
    assertNull(v1ClusterRefModel.getName());
  }
}