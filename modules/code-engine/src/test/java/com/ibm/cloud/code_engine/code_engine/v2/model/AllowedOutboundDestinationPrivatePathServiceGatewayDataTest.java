...
/**
 * Unit test class for the AllowedOutboundDestinationPrivatePathServiceGatewayData model.
 */
public class AllowedOutboundDestinationPrivatePathServiceGatewayDataTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAllowedOutboundDestinationPrivatePathServiceGatewayData() throws Throwable {
    AllowedOutboundDestinationPrivatePathServiceGatewayData allowedOutboundDestinationPrivatePathServiceGatewayDataModel = new AllowedOutboundDestinationPrivatePathServiceGatewayData();
    assertNull(allowedOutboundDestinationPrivatePathServiceGatewayDataModel.getEntityTag());
