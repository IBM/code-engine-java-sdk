...
public class JobRunsPager {
  ...
  /**
   * Constructs a new JobRunsPager instance with the specified client and options model instance.
   * @param client the CodeEngine instance to be used to invoke the "listJobRuns" method
   * @param options the ListJobRunsOptions instance to be used to invoke the "listJobRuns" method
   */
   ...
   * @return a List&lt;JobRun&gt; that contains the next page of results
   */
  public List<JobRun> getNext() {
    ...
    JobRunList result = client.listJobRuns(options).execute().getResult();
   ...
   * @return a List&lt;JobRun&gt; containing all results returned by the "listJobRuns" method
   */
  public List<JobRun> getAll() {
    List<JobRun> results = new ArrayList<>();
    while (hasNext()) {
      List<JobRun> nextPage = getNext();
