...
// >>> Replace "code_engine" with the correct value for your project
package com.ibm.cloud.code_engine.common;
...
public class SdkCommon {
    ...
    // >>> Replace "code-engine" with the parent project's artifactId (e.g. platform-services)
    private static String parentArtifactId = "code-engine";
