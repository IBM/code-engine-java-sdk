...
# IBM Cloud Code Engine Java SDK Version 3.1.1
...
--- | ---
[Code Engine](https://cloud.ibm.com/apidocs/codeengine/codeengine-v2.0.0) | com.ibm.cloud.code-engine:3.1.1
...
The current version of this SDK is: 3.1.1
...
```gradle
compile 'com.ibm.cloud:code-engine:3.1.1'
```
