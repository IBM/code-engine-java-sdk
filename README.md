...
# IBM Cloud Code Engine Java SDK Version 4.1.0
...
--- | ---
[Code Engine](https://cloud.ibm.com/apidocs/codeengine/codeengine-v2.0.0) | com.ibm.cloud.code-engine:4.1.0
...
The current version of this SDK is: 4.1.0
...
```gradle
compile 'com.ibm.cloud:code-engine:4.1.0'
```
